...
const HomePage = () => {
    ...
    <div className="search-item-wrapper d-flex">
        <img className=""
             alt=""
             src="./public/searchmd.svg"
        />

        <input type="text" className="search-item flex-grow-1" placeholder="Gõ tên món ăn, nhà hàng mà bạn đang muốn tìm" />
    </div>
        ...
        <div className="mb-3 categories-wrapper w-100 d-flex justify-content-between">
            <div className="category-card d-flex justify-content-center align-items-end"
               //  style="background-image: url('./public/6387ec276a4eb-62aa10dfb2adca268416cf2fd03d82f5transformed-4@2x.png'); background-size: contain"
                style={{
                    backgroundImage: "url('./public/6387f1a42a5ed-2cb5b1da8a9eb55b2b5f44f5062da90c31f7tz-rqtransformed-3@2x.png')" ,
            ...
            <div className="category-card d-flex justify-content-center align-items-end"
                ...
                style={{
                    backgroundImage: "url('./public/6387ee4da768d-7299a2512db8d117fdd5c117eb727927transformed-1@2x.png')" ,
                    backgroundSize: "contain"  
                }} 
                 >
